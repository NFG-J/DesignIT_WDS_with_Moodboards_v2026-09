...
import AssetManager from './modules/asset_manager.js';
import MoodboardManager from './modules/moodboard_manager.js';
import ProposalManager from './modules/proposal_manager.js';
import PreviewManager from './modules/preview_manager.js';
import StylePackageManager from './modules/style_package_manager.js';
import StyleAgentWorkflow from './modules/style_agent_workflow.js';
...
class App {
    ...
    async init() {
        try {
            ...
            // Initialize SDD mood-board and style-package workflow
            this.initializeStyleAgentWorkflow();
    ...
    /**
     * Initialize the mood-board and style-package workflow from the SDD.
     */
    initializeStyleAgentWorkflow() {
        this.managers.asset = new AssetManager(this.managers.notification);
        this.managers.moodboard = new MoodboardManager(this.managers.notification);
        this.managers.proposal = new ProposalManager(this.managers.notification);
        this.managers.preview = new PreviewManager(this.managers.notification);
        this.managers.stylePackage = new StylePackageManager(
            this.managers.component,
            this.managers.notification
        );
        this.managers.styleAgentWorkflow = new StyleAgentWorkflow({
            notification: this.managers.notification,
            moodboard: this.managers.moodboard,
            asset: this.managers.asset,
            proposal: this.managers.proposal,
            preview: this.managers.preview,
            stylePackage: this.managers.stylePackage,
            component: this.managers.component
        });
    }
